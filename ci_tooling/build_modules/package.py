...
class GeneratePackage:
    ...
    def __init__(self) -> None:
        ...
        """
        self._files = {
            "./dist/OCLP-R.app": "/Library/Application Support/sumitduster/OCLP-R.app",
    ...
    def _generate_installer_welcome(self) -> str:
        ...
        _welcome += "# Overview\n"
        _welcome += f"This package will install the OCLP-R application (v{constants.Constants().patcher_version}) on your system."

        _welcome += "\n\nAdditionally, a shortcut for OCLP-R will be added in the '/Applications' folder."
        _welcome += "\n\nThis package will not 'Build and Install OpenCore' or install any 'Root Patches' on your machine. If required, you can run OCLP-R to install any patches you may need."
        _welcome += f"\n\nFor more information on OCLP-R usage, see our [documentation]({constants.Constants().guide_link}) and [GitHub repository]({constants.Constants().repo_link})."
        _welcome += "\n\n"
    ...
    def _generate_uninstaller_welcome(self) -> str:
        ...
        _welcome += "This package will uninstall the OCLP-R application and its Privileged Helper Tool from your system."
        _welcome += "\n\n"
        _welcome += "This will not remove any root patches or OpenCore configurations that you may have installed using OCLP-R."
        _welcome += "\n\n"
        _welcome += f"For more information on OCLP-R, see our [documentation]({constants.Constants().guide_link}) and [GitHub repository]({constants.Constants().repo_link})."
    ...
    def _generate_autopkg_welcome(self) -> str:
        ...
        _welcome += f"[OCLP-R GitHub Release]({constants.Constants().repo_link})"
    ...
    def generate(self) -> None:
        ...
        Generate OCLP-R.pkg
        """
        print("Generating OCLP-R-Uninstaller.pkg")
        ...
        assert macos_pkg_builder.Packages(
            ...
            pkg_bundle_id="com.sumitduster.oclp-r-uninstaller",
            ...
            pkg_title="OCLP-R Uninstaller",
            pkg_welcome=self._generate_uninstaller_welcome(),
        ).build() is True

        print("Generating OCLP-R.pkg")
        ...
        assert macos_pkg_builder.Packages(
            ...
            pkg_bundle_id="com.sumitduster.oclp-r",
            pkg_version=constants.Constants().patcher_version,
        ...
        assert macos_pkg_builder.Packages(
            ...
            pkg_bundle_id="com.sumitduster.pkg.AutoPkg-Assets",
            pkg_version=constants.Constants().patcher_version,
            pkg_allow_relocation=False,
            pkg_as_distribution=True,
