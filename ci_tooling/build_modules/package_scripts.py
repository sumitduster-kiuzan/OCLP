...
class ZSHFunctions:
    ...
    def generate_fix_settings_file_permission(self) -> str:
        ...
        _script += "    local settingsPath=\"$pathToTargetVolume/Users/Shared/.com.sumitduster.oclp-r.plist\"\n\n"
    ...
    def generate_clean_launch_service(self) -> str:
        ...
        _script += "    local domain=\"com.sumitduster.oclp-r\"\n\n"
...
class GenerateScripts:
    ...
    def __init__(self):
        ...
        self.files = [
            ...
            "Library/Application Support/sumitduster/Update.plist",
            "Library/Application Support/sumitduster/OCLP-R.app",
            "Library/PrivilegedHelperTools/com.sumitduster.oclp-r.privileged-helper"
        ]

        self.additional_auto_pkg_files = [
            "Library/LaunchAgents/com.sumitduster.oclp-r.auto-patch.plist"
        ]
    ...
    def _generate_postinstall_script(self, is_autopkg: bool = False) -> str:
        ...
        _script += "helperPath=\"Library/PrivilegedHelperTools/com.sumitduster.oclp-r.privileged-helper\"\n"
        _script += "mainAppPath=\"Library/Application Support/sumitduster/OCLP-R.app\"\n"
