...
class Constants:
    def __init__(self) -> None:
        ...
        self.installer_pkg_url_nightly:       str = "http://nightly.link/sumitduster/OCLP-R/workflows/build-app-wxpython/main/AutoPkg-Assets.pkg.zip"
        ...
        self.mousse_version:     str = "0.95-sumitduster"  # MouSSE
    ...
    def overlay_psp_path_dmg(self):
        return self.original_path / Path("sumitdusterInternalResources.dmg")
    ...
    def auto_patch_launch_agent_path(self):
        return self.launch_services_path / Path("com.sumitduster.oclp-r.auto-patch.plist")

    @property
    def rsr_monitor_launch_daemon_path(self):
        return self.launch_services_path / Path("com.sumitduster.oclp-r.rsr-monitor.plist")

    @property
    def update_launch_daemon_path(self):
        return self.launch_services_path / Path("com.sumitduster.oclp-r.macos-update.plist")

    @property
    def kdk_launch_daemon_path(self):
        return self.launch_services_path / Path("com.sumitduster.oclp-r.os-caching.plist")
